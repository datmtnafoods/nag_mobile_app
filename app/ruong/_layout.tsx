...
export default function RuongLayout() {
  ...
  return (
    <Stack
      screenOptions={{
        ...
        headerLeft: () => <HeaderCloseButton fallbackHref="/den-ruong" />,
      }}
    >
      {/* Chọn / tạo nông hộ nằm ngay ở bước 1 của wizard tạo thửa — không tách
          màn picker riêng, đỡ một lần điều hướng khi đang đứng ngoài ruộng. */}
